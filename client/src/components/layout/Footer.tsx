  ...
  return (
    <footer className="bg-primary text-primary-foreground py-16 mt-20 border-t-4 border-secondary">
      <div className="container mx-auto px-4 text-center">
        <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center p-2 mx-auto mb-6 shadow-md">
          <img src={logoImage} alt="Ramstein Ryder Cup Logo" className="h-full w-full object-contain" />
        </div>
