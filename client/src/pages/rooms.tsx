...
const ROOM_PREVIEWS = [
  ...
  },
  {
    ...
    bathroomImage: bedroom3BathroomImage,
    bathroomLabel: "Bedroom #3 Bathroom",
    bathroomDescription: "Single vanity and walk-in shower setup connected to Bedroom #3.",
  },
  {
    image: bedroom4Image,
    label: "Bedroom #4",
  ...
  },
  {
    ...
    bathroomImage: bedroom5BathroomImage,
    bathroomLabel: "Bedroom #5 Bathroom",
    bathroomDescription: "Single vanity and walk-in shower setup connected to Casita Bedroom #5.",
  },
  {
    image: bedroom6Image,
    ...
    bathroomImage: bedroom6BathroomImage,
    bathroomLabel: "Bedroom #6 Bathroom",
    bathroomDescription: "Bathroom setup connected to Casita Bedroom #6.",
  },
  {
    image: bedroom7Image,
    ...
    bathroomImage: bedroom7BathroomImage,
    bathroomLabel: "Bedroom #7 Bathroom",
    bathroomDescription: "Single vanity and walk-in shower setup connected to Casita Bedroom #7.",
  },
  {
    image: bedroom8Image,
